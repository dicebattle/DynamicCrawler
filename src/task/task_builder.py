...
def parse_dict(dict_val: dict):
    import crawling.classes.genericparser.commands as cmd
...
def parse_list(list_val):
    import crawling.classes.genericparser.commands as cmd
    from crawling.classes.genericparser.task_array import TaskArray
    if len(list_val) == 0:
        return None
...
def parse_string(str_val: str):
    ...
    if str_val.startswith("$$"):
        from crawling.classes.genericparser.commands.get_result_task import GetResultTask
